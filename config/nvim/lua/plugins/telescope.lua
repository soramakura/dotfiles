local set_telescope_keymaps = function()
  ...
  set_keymap("n", "<leader>gb", builtin.git_branches, keymap_opts("Search git branches"))
  set_keymap("n", "<leader>gs", builtin.git_status, keymap_opts("Search git status"))
  set_keymap("n", "<leader>gt", builtin.git_stash, keymap_opts("Search git status file"))
  set_keymap("n", "<leader>gf", builtin.git_bcommits, keymap_opts("Search git file commits"))
  set_keymap("n", "<leader>gc", builtin.git_commits, keymap_opts("Search git commits"))
